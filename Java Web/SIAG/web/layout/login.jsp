        ...
        <div class="page-lock">
            ...
            <div class="page-body">
                ...
                <div class="lock-body">
                    ...
                    <form class="lock-form pull-left" action="${SUBDIR}/Login" method="post">
                        ${msgRetorno}
                        <div class="form-group"><input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Usuário" name="usuario" value="${userSave}" /> </div>
                        <div class="form-group"><input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Senha" name="senha" /> </div>
