        ...
        <div class="page-lock">
            ...
            <div class="page-body">
                ...
                <div class="lock-body">
                    ...
                    <form class="lock-form pull-left" action="${SUBDIR}/Login/recuperar" method="post">
                        <div class="form-group"><input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="E-mail" name="email" /> </div>
                        <div class="form-actions">
                            <button type="submit" class="btn red uppercase">Recuperar</button>
                        </div>
                    </form>
                </div>
