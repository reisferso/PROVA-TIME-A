...
<html lang="en">
    ...
    <head>
        ...
        <link href="${SUBDIR}/assets/pages/css/lock.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="page-lock">
            <div class="page-logo">
                <a class="brand" href="index.html">
                    <img src="${SUBDIR}/images/logo-branca.png" alt="logo" /> </a>
            </div>
            <div class="page-body">
                <div class="lock-head"> Recuperar senha </div>
                <div class="lock-body">
                    <div class="pull-left lock-avatar-block">
                        <img src="${SUBDIR}/images/perfis/branco.png" class="lock-avatar"> </div>
                    <form class="lock-form pull-left" action="" method="post">
                        ${msgRetorno}
                        <div class="form-group"><input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Senha" name="senha1" /> </div>
                        <div class="form-group"><input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirmação de senha" name="senha2" /> </div>
                        <div class="form-actions">
                            <button type="submit" class="btn red uppercase">Alterar senha</button>
                        </div>
                    </form>
                </div>
                <div class="lock-bottom">
                    <a href="${SUBDIR}/Login/recuperar">Esqueceu sua senha?</a>
                </div>
            </div>
            <div class="page-footer-custom"> 2016 &copy; FRADE Tecnologia. </div>
        </div>
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <script src="${SUBDIR}/assets/pages/scripts/lock.min.js" type="text/javascript"></script>
