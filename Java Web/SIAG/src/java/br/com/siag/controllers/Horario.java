 ...
 * @author marcus
 * 
 * CLASSE CONTROLLER RESPONSÁVEL POR AGRUPAR OS MÉTODOS QUE SERÃO RESPONSÁVEIS POR REALIZAR O AGENDAMENTO
 * 
 */
public class Horario extends Controller {
     ...
     * @throws IOException 
     * 
     * MÉTODO RESPONSÁVEL POR LISTAR A CATEGORIA DE SERVIÇO
     * E O SERVIÇO REFERENTE A ESSE TIPO VIA AJAX
     */
